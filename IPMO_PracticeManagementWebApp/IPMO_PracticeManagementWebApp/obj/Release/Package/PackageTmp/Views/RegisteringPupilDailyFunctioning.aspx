...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form1">
        <head>
            <title>Registering Pupil Daily Functioning</title>
            <meta charset="utf-8" />
                ...
                $(document).ready(function () {
                    ...
                    function getAllData() {
                        ...
                        $('tr.data-contact-person').each(function () {
                            ...
                            var formName = "Registering Pupil Daily Functioning";
                    ...
                    $("#btnSubmit").click(function () {
                        ...
                        $.ajax({
                            url: 'RegisteringPupilDailyFunctioning.aspx/SaveData',
                            type: 'POST',
                            dataType: 'json',
                            contentType: 'application/json; charset=utf-8',
                            data: JSON.stringify({ 'allData': data }),
                    ...
                    $("#btnView").click(function () {
                        ...
                        $.ajax({
                            url: 'RegisteringPupilDailyFunctioning.aspx/GetData',
                            type: 'POST',
                            dataType: 'json',
                            contentType: 'application/json; charset=utf-8',
                            data: JSON.stringify({ 'allData': data }),
                    ...
                    $("#btnUpdate").click(function () {
                        ...
                        $.ajax({
                            url: 'RegisteringPupilDailyFunctioning.aspx/UpdateData',
                            type: 'POST',
                            dataType: 'json',
                            contentType: 'application/json; charset=utf-8',
                            data: JSON.stringify({ 'allData': data }),
        ...
        <body>
            ...
            <div class="container">
                ...
                <p>
                    <h1>Registering Pupil's Daily Functioning</h1>
