            ...
            <script type="text/javascript">  
                $(document).ready(function () {
                    ...
                    function populateDataFromSession() {
                        ...
                        $.ajax({
                            url: 'PupilSchoolHistory.aspx/GetSessionData',
                            type: 'POST',
                            dataType: 'json',
                            ...
                            success: function (response) {
                                ...
                                if (response.d.length > 0) {
                                    for (let i = 0; i < response.d.length; i++) {
                                        ...
                                        else if (response.d[i].FieldName === "Primary Education") {
                                            $("#primaryEducationValue").val(response.d[i].FieldValue);
                                        }
                                        else if (response.d[i].FieldName === "Secondary Education") {
                                            $("#secondaryEducationValue").val(response.d[i].FieldValue);
                                        }
                                        else {
                                            var rowCount = $('.data-contact-person').length + 1;
                                            var contactdiv = '<tr class="data-contact-person">' +
                    ...
                    $("#btnUpdate").click(function () {
                        ...
                        $.ajax({
                            url: 'PupilSchoolHistory.aspx/UpdateData',
                            type: 'POST',
                            dataType: 'json',
                            contentType: 'application/json; charset=utf-8',
                            data: JSON.stringify({ 'allData': data }),
                ...
                <table class="table" id="maintable">
                    ...
                    <tbody>
                        ...
                        <tr class="data-contact-person">
                            ...
                            <td>
                                <textarea id="primaryEducationValue" name="l-name02" class="form-control l-name01" cols="20" rows="2"></textarea>
                            </td>
                        </tr>
                        <tr class="data-contact-person">
                            <td>
                            ...
                            <td>
                                <textarea id="secondaryEducationValue" name="l-name03" class="form-control l-name01" cols="20" rows="2"></textarea>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
