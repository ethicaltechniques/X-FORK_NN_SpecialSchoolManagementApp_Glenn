...
{
    public partial class RegisteringPupilDailyFunctioning : System.Web.UI.Page
    {
        ...
        public static List<FieldModel> GetData(string allData)
        {
            ...
            fmList = dqm.QueryToGetDataForField(passportNumber, "Registering Pupil Daily Functioning");
