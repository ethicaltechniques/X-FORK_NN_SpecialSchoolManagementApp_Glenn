...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form1">
        <head>
            <title>Result (applied means)</title>
            <meta charset="utf-8" />
            ...
            <script type="text/javascript">  
                $(document).ready(function () {
                    ...
                    function populateDataFromSession() {
                        ...
                        $.ajax({
                            url: 'ResultsAppliedMeans.aspx/GetSessionData',
                            type: 'POST',
                            dataType: 'json',
                    ...
                    function getAllData() {
                        ...
                        $('tr.data-contact-person').each(function () {
                            ...
                            var formName = "Results Applied Means";
                    ...
                    $("#btnSubmit").click(function () {
                        ...
                        $.ajax({
                            url: 'ResultsAppliedMeans.aspx/SaveData',
                            type: 'POST',
                            dataType: 'json',
                            contentType: 'application/json; charset=utf-8',
                            data: JSON.stringify({ 'allData': data }),
                    ...
                    $("#btnView").click(function () {
                        ...
                        $.ajax({
                            url: 'ResultsAppliedMeans.aspx/GetData',
                            type: 'POST',
                            dataType: 'json',
                            contentType: 'application/json; charset=utf-8',
                            data: JSON.stringify({ 'allData': data }),
                    ...
                    $("#btnUpdate").click(function () {
                        ...
                        $.ajax({
                            url: 'ResultsAppliedMeans.aspx/UpdateData',
                            type: 'POST',
                            dataType: 'json',
                            contentType: 'application/json; charset=utf-8',
                            data: JSON.stringify({ 'allData': data }),
                ...
                <table class="table" id="maintable">
                    <thead>
                        ...
                        <tr>
                            <td>
                                <b>
                                    <span class="label label-warning">Result Goals</span>
                                </b>
                            </td>
                            <td>
                                <b>
                                    <span class="label label-warning">Applied Means</span>
                                </b>
                            </td>
                        </tr>
                    </thead>
